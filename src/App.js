      ...
      <div>
        <Router>
          ...
          <Routes>
              ...
              <Route exact path="/entertainment" element={<News setProgress = {setProgress} apiKey={apiKey}  key="entertainment" toptitle="Top Headlines - " pageSize={pageSize} country="sp" category="entertainment"/>}/>
