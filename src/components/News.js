...
export default class News extends Component {
    ...
    constructor(props){
        ...
        document.title = `${this.capitalizeFirstLetter(this.props.category)} - Kathmandu Times`
    }

    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=0c5e0940eca74c6d89ba1ac79cc177c4&page=1&pageSize=${this.props.pageSize}`
  ...
  render() {
    ...
    return (
      <div className='container my-4'>
        <h2 className='mb-5 text-center'>{this.props.toptitle} {this.capitalizeFirstLetter(this.props.category)}</h2>
